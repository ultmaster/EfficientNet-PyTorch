...
def main_worker(gpu, args):
    ...
    if args.data == "cifar10":
        ...
        train_dataset = datasets.ImageNet(args.data, split="train", transform=train_transforms)
        val_dataset = datasets.ImageNet(args.data, split="test", transform=val_transforms)
